const words = [
    'MAMMA', 'PADRE', 'SCALA', 'TAVOLO', 'PIANO', 'CAMPO', 'STIVA', 'FUOCO', 'ACQUA', 'VINO', 'LIBRO', 
    'PARCO', 'SOGNO', 'CASCO', 'BORSA', 'COLLA', 'PESCE',  'PORTO', 'LENTE', 'NOTTE', 'CIELO', 'PIUMA', 
    'VOLTO', 'FANGO', 'PRATO', 'FRENO', 'ANGOLO', 'FRECCIA', 
    'MONDO', 'TEMPO', 'VENTO', 'SERRA', 'PUNTA', 'LUOGO', 
    'TESSA', 'DENTE', 'FATTO', 'LEGNO'
  ];
