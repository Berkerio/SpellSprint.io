const words = [
    'BAMBINO', 'ALBERGO', 'CAMMINO', 'CERCHIO', 'CUSCINO',
     'DISCORSO', 'FORMICA', 'INSEGNA',
    'LIBRONE', 'MAESTRO', 'MATTINO', 'MEMORIA', 'MESSAGGIO',
    'MONTATO', 'PAGELLA', 'PALLONE',
    'PANTERA', 'PANTONE', 'PIANTATO', 'PITTORE',
    'PROFETA', 'RAGAZZO', 'RICERCA', 'SANTITA', 'SCALINO',
    'SCIENZA', 'SENTIRE', 'SIGNORE', 'SPINOSA',
    'STRADA', 'TAVOLINO', 'TEATRO', 'TRAMITE', 'VALIGIA',
    'VIOLINO'
  ];
