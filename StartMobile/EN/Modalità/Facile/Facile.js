const words = [
    'APPLE', 'GRAPE', 'BRAIN', 'PLANE', 'HOUSE', 'LIGHT', 
    'TABLE', 'CHAIR', 'MOUSE', 'SOUND', 'TRAIN', 'WATER', 
    'WORLD', 'VIDEO', 'CLOCK', 'VOICE', 'PLANT', 'HEART', 
    'STORY', 'LEMON', 'SUGAR', 'FIELD', 'DRINK', 'NIGHT', 
    'SHAPE', 'SWORD', 'BOOKS', 'BRUSH', 'TRUCK', 'PIANO', 
    'LUNCH', 'DREAM', 'CLOUD', 'CROWN', 'GLASS', 'STONE', 
    'BREAD', 'STICK', 'MONEY', 'TIGER'
  ];
